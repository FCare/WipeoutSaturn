...
/// @defgroup MATH_FIX16_VEC4 3-vector
...
/// @param      v1     Not yet documented.
/// @param[out] result Not yet documented.
extern void fix16_vec4_cross(const fix16_vec4_t * const __restrict v0,
...
///
/// @returns The value.
extern fix16_t fix16_vec4_cross_mag(const fix16_vec4_t * __restrict v0,
